...
export function Vehicles({ id }: VehiclesProps) {
  ...
  const getVehicleDevices = async () => {
    try {
      ...
      const response = await axios.get(`${apiUrl}/societies/${params.societyId}/device/${id}/vehicles`,
        {
  ...
  const addVehicle = async (formData: { vehicleId: number }) => {
    try {
      const { data } = await axios.post(`${apiUrl}/societies/${params.societyId}/device/${params.id}/vehicle`,
  ...
  const handleDelete = async (Id: any) => {
    try {
      const { data } = await axios.delete(`${apiUrl}/societies/${params.societyId}/device/${params.id}/vehicle/${Id}`, {
        withCredentials: true,
      }
      );
