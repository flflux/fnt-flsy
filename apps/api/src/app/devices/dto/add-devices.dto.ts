...
import { AddDevice,EditDevice,EditDevicesKey,EditDevicesSetting, EditDevicesStatus } from '@fnt-flsy/data-transfer-types';

export class AddDevicesDto
  extends PickType(DeviceDto, ['name','deviceId', 'type'])
  implements AddDevice { @ApiProperty() deviceKey: string;}
...
export class EditDevicesSettingDto
  extends PickType(DeviceDto, ['deviceId', 'thingId', 'thingKey', 'channelId','type'])
