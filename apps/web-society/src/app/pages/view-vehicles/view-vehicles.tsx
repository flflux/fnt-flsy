...
export function ViewVehicles(props: ViewVehiclesProps) {
  ...
  const breadcrumbs = [
    ...
    {
      to: `/societies/${params.societyId}/buildings/${params.buildingId}/floors/${params.floorId}/flats/${params.flatId}`,
      label: `${data?.flats[0]?.flats?.number}`,
    },
    {
      label: `${data?.name}`
    }
  ...
  return (
    <div className={styles['container']}>
      ...
      <Box className={styles['card_container']}>
        ...
        {loadingVehicleCard ? (
          ...
          data.cards.map((card: CardDetail, index: number) => (
            <React.Fragment key={index} >
              <Card className={styles['card-card']} sx={{ minWidth: 275, boxShadow:8 }}>
                ...
                <CardContent>
                  <Box>
                    <Grid className={styles['vehicle-grid']} container spacing={3.5} columnGap={0.01} padding={1} >
          ...
          <Card className={styles['card-card']} sx={{ minWidth: 275, boxShadow:8 }}>
            ...
            <CardContent>
              <Box>
                <Grid className={styles['vehicle-grid']} container spacing={3.5} columnGap={1} padding={1} >
                  <Grid item xs={5} justifyContent="flex-start"><Typography className={styles['card-typo']} >Card Number</Typography></Grid>
      ...
      <Card sx={{ minWidth: 300, margin:4 }} className={styles['Details-card']}>
        <CardContent>
