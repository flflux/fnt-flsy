...
export class FlatsController {
  ...
  async getFlatForBuilding(
    ...
    @Post('/societies/:societyId/buildings/:buildingId/floors/:floorId/flats/bulkupload')
    @HttpCode(HttpStatus.CREATED)
    ...
    {
      return this.flatsService.bulkUploadFlatData(+societyId,+buildingId,+floorId, fileDto,file);
    }
  ...
  add(
    ...
    @Param('buildingId') buildingId: number,
    @Param('floorId') floorId: number,
    @Body() addFlatDto: AddFlatDto): Promise<ViewFlatDto> {
  ...
  findById(
    ...
    @Param('buildingId') buildingId: number,
    @Param('floorId') floorId: number,
    @Param('id') id: number, @Request() req): Promise<ViewFlatDto> {
    const { user } = req;
    return this.flatsService.findById(+societyId, +buildingId,+floorId,+id, user.id);
  }
  ...
  @Param('buildingId') buildingId: number,
  @Param('floorId') floorId: number,
  @Param('id') id: number, ): Promise<ListFlatDto> {
    return this.flatsService.edit(flatDto, +societyId,+buildingId,+floorId,+id);
  }
  ...
  @UseGuards(AuthGuard,RolesGuard)
  @Roles(Role.FOUNTLAB_ADMIN, Role.ORGANIZATION_ADMIN,Role.SOCIETY_ADMIN)  
  @Delete('/societies/:societyId/buildings/:buildingId/floors/:floorId/flats/:id')
  @HttpCode(HttpStatus.NO_CONTENT)
  @ApiOkResponse()
  //   @Roles(Role.FOUNTLAB_ADMIN)
  hardDeleteFlat(
