  ...
  const handleFormSubmit = (data: Form) => {
    ...
    const getAllBuildings = useCallback(async () => {
      try {
        ...
        console.log("get all buildings for flat",response.data);
        const { content, total } = response.data;
        console.log(' totalbuidligng', total)
        setTotalbuildingValue(total);
        const Buildings = response.data.content;
        console.log(response.data);
        setBuildingList(Buildings);
       
        console.log(totalbuildingValue)
      } catch (error) {
        console.log(error);
        console.log('Something went wrong');
      }
    },[params.societyId, totalbuildingValue, page]);


    useEffect(() => {
    getAllBuildings();
     } , [getAllBuildings, totalbuildingValue, page]);
